...
#define H8_3069F_SCI_SCR_TIE    (1<<7) /* transmit interrupt enbale */
...
int serial_init(int index) {
  ...
  sci->scr = 0;
  sci->smr = 0;
  sci->brr = 64; /* 20MHz -> 96bps */
  sci->scr = H8_3069F_SCI_SCR_RE | H8_3069F_SCI_SCR_TE; /* r/t enbale */
  sci->ssr = 0;
...
void serial_intr_send_diable(int index) {
  volatile struct h8_3069f_sci *sci = regs[index].sci;
  sci->scr &= ~H8_3069F_SCI_SCR_TIE;
}
